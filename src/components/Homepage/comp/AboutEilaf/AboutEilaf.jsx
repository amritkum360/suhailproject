...
import "./AboutEilaf.css"; // External CSS for background image
  ...
  return (
    <section className="about-section text-white text-center py-5">
      <div className="container">
        ...
        <p className="">
          <strong>Learn Quran online</strong> with our dedicated system for e-Learning Quran, Islam, and Arabic by expert tutors.
        </p>

        <p className="">No matter where you live, we provide <strong>online Quran classes</strong> for all students around the world.</p>
