...
Egyptian Arabic language course
          ...
          <p className="text-gray-600">The Egyptian Arabic language is the main language in Egypt and the most spoken language among the Arabic languages because it is simple and easy to communicate with. All Arabs understand the Egyptian Arabic language. The Egyptian Arabic language has a variety of Egyptian versions; every country has its vernacular that speaks with each other, so the Arabic language in Egypt has many varieties, but some vernaculars are popular and most understood by the Egyptians and Arab people.
</p>
          <Link
  to="/freetrail"
