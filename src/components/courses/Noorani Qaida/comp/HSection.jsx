...
>
  Noorani Qaida
          ...
          <p className="text-gray-600">Noorani Qaida is a method that looks like a treasure map for beginners to help them learn how to read the holy Quran. This method is designed to teach beginners and kids the basic tajweed rules and pronounce the Arabic letter step by step until they become masters at this part. This course focuses on helping them to become advanced in reading. By the end of the course, they can recite the holy Quran correctly.</p>
          <Link
  to="/freetrail"
